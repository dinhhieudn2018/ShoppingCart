...
class ProductTypeController extends Controller
{
    ...
    {
        $producttype = ProductTypes::paginate(10);
    ...
    public function store(StoreProductTypeRequest $request)
    {
        ...
        if(ProductTypes::create($data)){
            return redirect()->route('producttype.index')->with('thongbao','Đã thêm thành công sản phẩm');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        $validator = Validator::make($request->all(),
            ...
            [
                ...
                'name.min' => 'Tên loại sản phẩm tối thiểu có 2 kí tự',
                'name.max' => 'Tên loại sản phẩm tối đa có 255 kí tự',
        ...
        if($producttype->update($data)){
            ...
            return response()->json(['result' => 'Không thành công'],200);
        }
